...
struct BlueCursorView: View {
    ...
    private let fullWelcomeMessage = "やあ！ぼくはデイトラちゃん"
    ...
    var body: some View {
        ZStack {
            ...
            // Onboarding prompt — streamed after welcome message
            ...
            Image("daytora-chan")
                ...
                .shadow(color: .pink.opacity(0.4), radius: 6 + (buddyFlightScale - 1.0) * 15, x: 0, y: 0)
    ...
    private func startWelcomeAnimation() {
        ...
        // Speak the welcome message with VOICEVOX (ずんだもん)
        companionManager.speak(fullWelcomeMessage)
